                      ...
                      Container(
                        ...
                        child: PageView.builder(
                          ...
                          onPageChanged: (int page) {
                            setState(() {
                              currentPage = page; // Update the currentPage when the page changes
                            });
                          },
                          ...
                          itemBuilder: (context, index) {
                            return ClipRRect(
                              ...
                              child: Image.asset(
                                imageAssets[index],
                                width: double.maxFinite, // Adjust width to fit the screen
                                height: 200,
                                fit: BoxFit.cover,
                              ),
                            );
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: Colors.grey[200], // Adjust the box background color as needed
                          ),
                          padding: EdgeInsets.symmetric(vertical: 2, horizontal: 5), // Add padding to control box size
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween, // Add space between indicators
                            children: [
                              for (int i = 0; i < imageAssets.length; i++)
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    color: i == currentPage ?Color(0xFF21D4B4): Colors.grey, // Use different colors for selected and unselected dots
                                  ),
                                ),
                            ],
                          ),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image.asset(
                        'images/Category.png', // Replace with your image path
                        width: 40, // Adjust the image size as needed
                        height: 20,
                      ),
                      SizedBox(height: 8),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image.asset(
                        'images/Category (1).png', // Replace with your image path
                        width: 40, // Adjust the image size as needed
                        height: 20,
                      ),
                      SizedBox(height: 8),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image.asset(
                        'images/Category (2).png', // Replace with your image path
                        width: 40, // Adjust the image size as needed
                        height: 20,
                      ),
                      SizedBox(height: 8),
